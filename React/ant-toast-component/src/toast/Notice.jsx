    ...
    return (
      <div className={`toast-notice ${type}`}>
        <svg style={{ display: 'none' }}>
          ...
          <symbol id="icon-check-circle-fill" viewBox="0 0 1024 1024">
            <path 
          ...
          <symbol id="icon-close-circle-fill" viewBox="0 0 1024 1024">
            <path 
          ...
          <symbol id="icon-info-circle-fill" viewBox="0 0 1024 1024">
            <path 
          ...
          <symbol id="icon-warning-circle-fill" viewBox="0 0 1024 1024">
            <path 
